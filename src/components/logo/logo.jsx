...
export const Logo = forwardRef((props, ref) => {
  ...
  const fullLogo = <img alt="T.C. Enerji ve Tabii Kaynaklar Bakanlığı" src="/etkb-logo.svg" />;
...
export const LogoSmall = forwardRef((props, ref) => {
  const { className, href = "/", isSingle = true, disabled, sx, ...other } = props;
