  ...
  base: [
    {
      ...
      style: ({ theme }) => ({
        ...
        [`& .${LoadingButton.classes?.loadingIndicatorStart}`]: { left: 14 },
        [`& .${LoadingButton.classes?.loadingIndicatorEnd}`]: { right: 14 },
        [`&.${buttonClasses.sizeSmall}`]: {
          [`& .${LoadingButton.classes?.loadingIndicatorStart}`]: { left: 10 },
          [`& .${LoadingButton.classes?.loadingIndicatorEnd}`]: { right: 10 },
        },
      }),
    },
  ],
