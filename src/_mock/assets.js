...
export const _prices = [
  52200, 9000, 18000, 765, 75000, 2080, 152000, 900, 2000, 300, 400, 801, 700, 1300, 600, 60, 550,
  288, 360, 4.32, 10.8, 28.8, 18, 72, 108, 1620, 43.2, 7.2, 21.6, 43.2, 12.6, 25.2, 28.8, 9, 3.6,
  10.8, 18, 5.4, 21.6, 7.2, 16.2, 14.4, 10.8, 180, 3.6, 7.2, 5.4, 36, 9, 28.8, 10.8, 9, 12.6, 4.32,
  10.8, 16.2, 9, 10.8, 5.4, 28.8, 36, 43.2, 288, 720, 54, 21.6, 10.8, 32.4, 16.2, 10.8, 43.2, 10.8,
  9, 36, 5.4, 4.32, 10.8, 28.8, 7.2, 144, 540, 2160, 162, 720, 28.8, 43.2, 5.4, 28.8, 18, 10.8, 360,
  28.8, 216, 72, 540, 432,
];
...
export const _speed = [45000, 6300, 7100, "", 87000, "", 195000];
...
export const _postTitles = [
  ...
  `Genel Müdürlerimiz Bayramlaşma Merasimi`,
  `Bakanlık bünyesinde iftar organizasyonu yapıldı.`,
  `Almanya Heyeti kurumumuzu ziyaret etti.`,
...
export const _jobTitles = [
  `2024 TOGG T10X V2 UZUN MENZİL`,
  `2022 MODEL VESPA SUPERSPORT 300CC /6.000KM`,
  `2023 MODEL STREET BOB FULL AKSESUAR RİNEHART EGZOZ`,
  `Elektrikli Scooter Ov-012 800 Watt`,
  `2023 SUZUKI JİMMNY 1.5 GLX 4X4-ISITMA-GERİ GÖRÜŞ`,
  `MACBOOK PRO 16" 2020 İ9 32GB 1TB SSD 8GB`,
  `2015 AUDİ A3 1.6 TDI HATCHBACK`,
  `APPLE WATCH SE`,
...
export const _sentences = [
  ...
  `Bakanlık ön bahçede tüm birim yöneticileri ile bayramlaşma gerçekleştirildi.`,
  `Tüm bakanlık personeli iftara katıldı.`,
  `Alman Heyet çalışma faaliyetlerimizi yerinde inceledi.`,
