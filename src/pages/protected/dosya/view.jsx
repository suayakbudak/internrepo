...
import { FileManagerNewFolderDialog } from "../dosya-yonetimi/components/file-manager-new-folder-dialog";
import { FileManagerPanel } from "../dosya-yonetimi/components/file-manager-panel";
import { FileManagerFolderItem } from "../dosya-yonetimi/components/file-manager-folder-item";

import { FileStorageOverview } from "./components/file-storage-overview";
import { FileWidget } from "./components/file-widget";
import { FileDataActivity } from "./components/file-data-activity";
import { FileRecentItem } from "./components/file-recent-item";
import { FileUpgrade } from "./components/file-upgrade";
        ...
        <Grid container spacing={3}>
          ...
          <Grid size={{ xs: 12, md: 6, lg: 8 }}>
            ...
            <Box sx={{ mt: 5 }}>
              <FileManagerPanel
                title="Folders"
                link={paths.anasayfa.dosyaYonetimi}
