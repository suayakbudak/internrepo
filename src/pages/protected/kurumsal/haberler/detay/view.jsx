...
import { PostDetailsSkeleton } from "./components/post-skeleton";
...
import { PostDetailsToolbar } from "./components/post-details-toolbar";
        ...
        <EmptyContent
          ...
          action={
            <Button
              ...
              href={paths.anasayfa.kurumsal.haberler.root}
    ...
    <DashboardContent maxWidth={false} disablePadding>
      <Container maxWidth={false} sx={{ px: { sm: 5 } }}>
        <PostDetailsToolbar
          ...
          editHref={idParam(paths.anasayfa.kurumsal.haberler.duzenle, post?.title)}
          liveHref={idParam(paths.haberler.details, post?.title)}
          publish={publish}
