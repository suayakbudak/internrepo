...
import { InvoiceAnalytic } from "./components/invoice-analytic";
import { InvoiceTableRow } from "./components/invoice-table-row";
import { InvoiceTableToolbar } from "./components/invoice-table-toolbar";
import { InvoiceTableFiltersResult } from "./components/invoice-table-filters-result";
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.anasayfa.admin.insanKaynaklari.masraflar.olustur}
              variant="contained"
                  ...
                  {dataFiltered
                    ...
                    .map((row) => (
                      <InvoiceTableRow
                        ...
                        editHref={idParam(
                          paths.anasayfa.admin.insanKaynaklari.masraflar.duzenle,
                          row.id
                        )}
                        detailsHref={idParam(
                          paths.anasayfa.admin.insanKaynaklari.masraflar.details,
                          row.id
                        )}
                      />
                    ))}
