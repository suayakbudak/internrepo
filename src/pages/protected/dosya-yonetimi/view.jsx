...
import { FileManagerFiltersResult } from "./components/file-manager-filters-result";
...
export function FileManagerView() {
  ...
  const renderConfirmDialog = () => (
    <ConfirmDialog
      ...
      content={
        <>
          <strong> {table.selected.length} </strong> dosya silinecektir, emin misiniz?
        </>
      }
      action={
        <Button
    ...
    <>
      <DashboardContent>
        <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <Typography variant="h4">Dosya Yönetimi</Typography>
          <Button
            variant="contained"
