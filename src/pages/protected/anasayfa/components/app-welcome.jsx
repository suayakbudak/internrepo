      ...
      sx={[
        (theme) => ({
          ...theme.mixins.bgGradient({
            images: [
              `linear-gradient(to right, ${varAlpha(theme.vars.palette.grey["900Channel"], 0.5)} 0%, ${theme.vars.palette.grey[900]} 75%)`,
              `url(${CONFIG.assetsDir}/assets/images/about/dosya.png)`,
            ],
          }),
          pt: 5,
          pb: 5,
